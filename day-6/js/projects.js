                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ${dt.teknologi.map(tli => {
                            if (tli === "Node JS") {
                                return `<i class="fs-3 me-3 fa-brands fa-node-js"></i>`;
                            } else if (tli === "Vue JS") {
                                return `<i class="fs-3 me-3 fa-brands fa-vuejs"></i>`;
                            } else if (tli === "Golang") {
                                return `<i class="fs-3 me-3 fa-brands fa-golang"></i>`;
                            } else {
                                return `<i class="fs-3 me-3 fa-brands fa-python"></i>`;
                            }
                        }).join("")}
                    </div>
                    <div class="row gx-1 gy-md-2 gy-sm-2 btns">
                        <div class="col-lg-6 d-grid">
                            <a class="btn btn-dark" href="detail.html?id=${dt.id}" role="button">
